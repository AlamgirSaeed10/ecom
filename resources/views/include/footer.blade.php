                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption">
                                ...
                                <div class="footer-logo mb-25">
                                    <img src="{{ url('assets/img/gallery/some_570x230.png')}}"
                                        alt="eComGladiators" class="w-100">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                        <div class="single-footer-caption">
                            <div class="footer-tittle">
                                <h4>Contact Info</h4>
                                <ul class="text-white">
                                    <li><a href="https://goo.gl/maps/L435e37Q5qm67Sf66" target="_blank">
                                        Basement, Malik Tower, Block B Citi Housing Jhelum</a></li>
                                    <li>Monday to Friday</li>
                                    <li>10:00AM - 5:00PM (Onsite)</li>
                                    <li>09:00PM - 3:00AM (Online)</li>
                                </ul>
                            </div>
                            <div class="col-sm-12 mx-auto py-3 pl-0">
                                <div class="footer-social">
                                    ...
                                    <a class="a-linkedin" href="https://t.me/ecomgladiators" target="_blank"><i class='fab fa-telegram-plane'></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-footer-caption">
                            <div class="single-footer-caption" style="height:150px; width:150px;">
                                ...
                                <a href="https://eservices.secp.gov.pk/eServices/ControllerServlet?request_id=VERIFY_ONLINE_INCORP_CERT&id=0208828"
                                    target="_blank">
                                    <div class="footer-logo secp_reg">
                                        <img src="{{ url('assets/img/gallery/eservices_verified.png')}}" alt=""class="w-100">
                                    </div>
                                </a>
                                {{-- <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p>Main description of eComGladiators will be added here.</p>
                                    </div>
                                </div> --}}
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 ">
                            <div class="footer-copy-right text-center">
                                <p class="text-center">
                                    ...
                                    </script> All rights reserved | EcomGladiators (Private) Limited | <a href="{{route('sitemap.page')}}" class="">Sitemap</a>
                                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                </p>
                            </div>
                        </div>
