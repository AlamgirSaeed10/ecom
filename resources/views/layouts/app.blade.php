                ...
                <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{route('dashboard')}}" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="{{asset('assets/img/logo/logo-text.png')}}" alt="Ecom gladiator logo" height="70">
                                </span>
                            </a>
                            ...
                            <li>
                             ...
                             <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('admin.add-certificate')}}" key="t-default">Add Certificate</a></li>
                                    <li><a href="{{route('admin.view-certificate')}}" key="t-saas">View Certificate</a></li>
                                </ul>
                            </li>
                             <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('admin.add-courses')}}" key="t-default">Add Courses</a></li>
                                    <li><a href="{{route('admin.view-courses')}}" key="t-saas">View Courses</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                <i class="bx bx-user-plus"></i><span key="t-dashboards">Enrollment</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('admin.add-enrollment')}}" key="t-blog">Add Enrollment</a></li>
                                </ul>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('admin.view-enrollment')}}" key="t-blog">View Enrollment</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="bx bx-id-card"></i><span key="t-dashboards">Membership</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('admin.add-membership')}}" key="t-blog">Add Membership</a></li>
                                </ul>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('admin.view-membership')}}" key="t-blog">View Membership</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                    <i class="bx bx-check-shield"></i><span key="t-dashboards">Administration</span>
                                </a>
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('admin.view-reports')}}" key="t-blog">Reports</a></li>
                                </ul>
                            </li>
